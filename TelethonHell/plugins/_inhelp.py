    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            if a:
                ...
                help_pic = "https://te.legra.ph/file/21983e736bf81c0b5bbec.jpg"
            ...
            if a:
                ...
                PIC = "https://telegra.ph/file/75c5c84746ad1d7fb64fc.jpg"
            ...
            if a and a == "DISABLE":
                ...
                PIC = "https://te.legra.ph/file/645d6a56f8d5aeee7c80c.jpg"
            if PIC and PIC.endswith((".jpg", ".png")):
                result = builder.photo(
                    file=PIC,
                    text=HELL_FIRST,
